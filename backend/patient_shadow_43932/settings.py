"""
Django settings for patient_shadow_43932 project.
...
ROOT_URLCONF = 'patient_shadow_43932.urls'
...
WSGI_APPLICATION = 'patient_shadow_43932.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_shadow_43932 API",
    "DESCRIPTION": "API documentation for patient_shadow_43932 App",
    "VERSION": "v1",
}
